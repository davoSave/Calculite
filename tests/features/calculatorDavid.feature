...
Scenario: Doing consecutive operations without entering any new numbers
Given the display shows the following value “<displayValue>”
And the user writes the “<firstNumber>” button
And the user presses the “<operand>” button
And the user writes the “<secondNumber” button
...
Examples:
| displayValue | firstNumber | operand | secondNumber | equal | displayResult |
|                   0 |                  3 |            + |                       3 |        = |                    9 |
|                   0 |                 -3 |            - |                      -3 |         = |                    3 |
|                   0 |                  3 |            * |                       2 |         = |                  12 |
|                   0 |               0,2 |            / |                     0,2 |         = |                   5 |
...
And the “=” button should be disabled
And the "+" button should be enabled (if “+” button is pressed, this should be disabled)
And the "-" button should be enabled (if “-” button is pressed, this should be disabled)
And the "*" button should be enabled (if “*” button is pressed, this should be disabled)
And the "/" button should be enabled (if “/” button is pressed, this should be disabled)
...
Scenario: Disabling buttons with comma
Given the display shows the following value: "1"
When the user presses the "," button
Then the "0" button should be enabled
And the "1" button should be enabled
